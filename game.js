...
var Enemy = function (image) {
    ...
    Enemy.prototype.SPEED_X = 16;
    Enemy.prototype.SPEED_Y = 32;
...
var EnemyManager = function () {
    ...
    EnemyManager.prototype.FINALCOUNT = 30;
...
EnemyManager.prototype.generateEnemies = function () {
    ...
    EnemyManager.prototype.FINALLENGTH = this.enemyList.length;
};

EnemyManager.prototype.draw = function (context) {

    var Judge =
        this.enemyList.some(function (enemy) {
            if (enemy.pos.x > WIDTH - enemy.SIZE / 2|| enemy.pos.x < enemy.SIZE / 2) {
            return true;
            }
        });
    ...
    if (this.COUNT == this.FINALCOUNT) {
        this.enemyList.forEach(function (enemy) {
            ...
            if (this.LENGTH <= this.FINALLENGTH / 2) {
                this.FINALCOUNT = 10;
            }
...
EnemyManager.prototype.collision = function (bullet) {
    ...
    if (target != null) {
        ...
        SCORE += 500;
        $("#score").text(SCORE);
        EnemyManager.prototype.LENGTH = this.enemyList.length;
