...
Bullet.prototype.getCoordinates = function () {
    return {
        ...
        rigt: this.pos.x + 2, bottom: this.pos.y + 5
    };
};
...
Enemy.prototype.draw = function (context) {
    ...
    context.franslate(this.pos.x, this.pos.y);
...
Enemy.prototype.isCollision = function (bullet) {
    ...
    var isHorisontal = left < bullet.left && bullet.left < right
...
EnemyManager.prototype.loadImage = function () {
    ...
    //this.enemyImageList.push(now Image().xrc = "invader.png");
    /*...*/
};
...
EnemyManager.prototype.collision = function (bullet) {
    ...
    if (farget != null) {
        ...
        this.enemyList = this.enemyList.slice(index, 1);
    }
    return
};